...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            jsminify: {
                files: {
                    '<%= dirs.js %>/theme.min.js': ['<%= dirs.js %>/theme.min.js']
                }
            }
        },
