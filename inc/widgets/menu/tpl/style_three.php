<div class="menu-design-3">
	...
	if(!empty( $options )){
    	...
    	$sorting_array = explode( ',', $options );
	    	echo '<ul class="nav nav-pills" id="myTabs">';
        ...
        <select name="tr_menu_select" class="tr_menu_select"></select>
			...
			<div class="tab-content clearfix">
                ...
                foreach( $sorting_array as $option ){
                    ...
                    <div role="tabpanel" class="tab-pane fade <?php echo $pi == 0 ? 'in active' : ''; ?>" id="<?php echo $category_info->slug; ?>" tabcontent="#<?php echo $category_info->slug; ?>">
                    	...
                    	<div class="col-md-12 tr-pl-0px">
							...
							echo 'color:' . $instance['heading_color'] . ';'; ?>text-align: center;line-height: 24px"><?php echo get_the_title(); ?><br/>

                               <?php
                                if (!empty($instance['content']) == 'show') { ?>
                                    <span class="price-item-subheading" style="color:<?php echo $instance['heading_color']; ?>; font-size:18px; font-weight: 400;padding-top:10px;"><?php echo get_the_content(); ?></span>
                                <?php } ?>
                            </h1>
                    	</div>
                        ...
                        foreach ($menu_lists as $post) {
                            ...
                            if (!empty($menu_lists)) {
                                ...
                                foreach ($menu_lists as $menu_list) {
                                    ...
                                    ?>
                                    <div class="col-md-12 tr-pl-0px">
                                        <div class="menu-list-item" style="<?php if($instance['border_line']=='show'){ echo 'border-bottom: 1px solid' . $instance['heading_color'];} ?>">
