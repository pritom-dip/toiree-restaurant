<div class="menu-design-2">
    ...
    if(!empty( $options )){
        echo '<div class="tr-menu-left-content-wrapper" style="border:1px solid ' . $instance['heading_color'] . '">';
        ...
        <div class="tr-menu-right-content-wrapper" style="border:1px solid <?php echo $instance['heading_color'] ?>">
                ...
                foreach( $sorting_array as $option ){
                    ...
                    <div role="tabpanel" class="tab-pane fade <?php echo $pi == 0 ? 'in active' : ''; ?>" id="<?php echo $category_info->slug; ?>" tabcontent="#<?php echo $category_info->slug; ?>">
                        ...
                        <?php foreach ($menu_lists as $post) {
                            setup_postdata($post);
                            ?>
                            <div class="heading-wrapper <?php echo $show_class; ?>">
