...
class ContentGrid_Widget extends Thim_Widget {
	function __construct() {
		parent::__construct(
			'contentgrid',
			esc_attr__( 'TT: Content Grid Design Two', 'themeplate' ),
			array(
			...
			TP_THEME_DIR . 'inc/widgets/contentgrid'
		);
	}
...
function thim_contentgrid_register_widget() {
	register_widget( 'ContentGrid_Widget' );
}

add_action( 'widgets_init', 'thim_contentgrid_register_widget' );