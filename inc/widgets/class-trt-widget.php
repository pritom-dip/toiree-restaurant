	...
	abstract class Thim_Widget extends WP_Widget
	{
		...
		public function form($instance)
		{
			...
			<a href="<?php echo esc_url($this->widget_options['help']) ?>"
			   ...
			   target="_blank"><?php esc_attr_e('Help', 'thim-framework') ?></a>
		<?php endif; ?>
		...
		function enqueue_scripts()
		{
			...
			if (!wp_script_is('thim-widget-admin')) {
				...
				wp_enqueue_style('thim-widget-admin', TP_THEME_URI . '/inc/admin/assets/css/widget-admin.css', array('media-views'), THIM_CORE_VERSION);
				wp_enqueue_style('thim-font-awesome');

				wp_enqueue_script('wp-color-picker');
				wp_enqueue_media();

				wp_enqueue_script('thim-widget-admin', get_template_directory_uri() . '/inc/admin/assets/js/widget-admin.min.js', array(), THIM_CORE_VERSION, true);
			...
			switch ($field['type']) {
				...
				case 'color' :
					...
					<input type="text" name="<?php echo esc_attr($this->so_get_field_name($name, $repeater)) ?>"
						   ...
						   class="widefat thim-widget-input thim-widget-input-color" /><?php
					break;
				...
				case 'radio':
					...
					<label for="<?php echo esc_attr($this->so_get_field_id($name, $repeater)) . '-' . $k ?>">
						<input type="radio" name="<?php echo esc_attr($this->so_get_field_name($name, $repeater)) ?>"
							   id="<?php echo esc_attr($this->so_get_field_id($name, $repeater)) . '-' . $k ?>"
				...
				case 'checkbox':
					?>
					<label for="<?php echo esc_attr($field_id) ?>">
						<input type="checkbox" name="<?php echo esc_attr($this->so_get_field_name($name, $repeater)) ?>"
							   id="<?php echo esc_attr($field_id) ?>"
				...
				case 'repeater':
					...
					?>
					<div class="thim-widget-field-repeater" data-item-name="<?php echo esc_attr($field['item_name']) ?>"
