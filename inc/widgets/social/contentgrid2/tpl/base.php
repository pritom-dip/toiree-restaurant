<div class="tr_masonry_full_wrapper tr_contentgrid_2">
	...
	<div class="tr_masonry_item hidden-lg hidden-md" style="content:url(<?php echo $src; ?>);">
	</div>
	...
	<div class="tr_masonry_item hidden-sm hidden-xs" style="content:url(<?php echo $src; ?>);">
	</div>
