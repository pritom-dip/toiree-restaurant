 ...
 * @return string
 */
function trt_template_path()
{
    return TRT_Theme_Wrapper::$main_template;
}
...
{
    return TRT_Theme_Wrapper::$base;
}

/**
 * Theme wrapper class
 */
class TRT_Theme_Wrapper
{
...
add_filter('template_include', array('TRT_Theme_Wrapper', 'wrap'), 99);
