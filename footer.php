...
$border_top = '';
$class2 = '';
if (get_theme_mod('footer_style') == true) {
	$class = 'container container_custom';
...
<?php if (get_theme_mod('footer_background_img')) {
	$style = 'background-image: url(' . trt_ssl_secure_url(get_theme_mod('footer_background_img')) . ');';
} else {
	$style = '';
} ?>

<footer style="<?php echo $style; ?>" id="colophon" class="site-footer <?php echo $class2; ?>">
	<?php if (get_theme_mod('footer_style') == false) { ?>
		<div class="<?php echo $class; ?>">
			<div class="row">
...
<?php if (get_theme_mod('show_to_top') === true) { ?>
